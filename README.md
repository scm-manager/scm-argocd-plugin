...
Integrates Argo CD build pipelines

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-argocd-plugin/docs/).
